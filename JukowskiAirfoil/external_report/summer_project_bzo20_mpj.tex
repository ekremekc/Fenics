...
\begin{figure}[hbtp]
    \centering
    \subfloat[]{\includegraphics[width=0.4\textwidth]{circ_force_val_conv_plot}}
    \qquad
    \subfloat[]{\includegraphics[width=0.4\textwidth]{circ_force_diff_conv_plot}}
...
[At high Reynolds number, I would expect C'_d to be 0. At low Reynolds number, I would expect $d(c_d)/d(Re) \sim -1/Re^2$. the most informative is, I think, $$d(c_d)/d(Re)$, which can be compared with the attached file Cd\_Re\_shapes.pdf]
